#ifndef slic3r_WebPresetDialog_hpp_
#define slic3r_WebPresetDialog_hpp_
...
class WebPresetDialog : public DPIDialog
{
public:
    WebPresetDialog(GUI_App* pGUI, long style = wxCAPTION | wxCLOSE_BOX | wxSYSTEM_MENU);
    virtual ~WebPresetDialog();
